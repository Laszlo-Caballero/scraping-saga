...
class SagaKeys(Enum):
    ...
    BRAND_CLASS = 'jsx-848928493.title1.secondary.jsx-233704000.bold.pod-title.title-rebrand'
    NAME_CLASS = 'jsx-848928493.copy2.primary.jsx-233704000.normal.line-clamp.line-clamp-3.pod-subTitle.subTitle-rebrand'
